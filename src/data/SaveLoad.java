...
public class SaveLoad {
    ...
    public void save(String string) {
        try {
            ...
            ds.worldTimeCounterForStartJobAfterChangeJob = gamePanel.worldTimeCounterForStartJobAfterChangeJob;
    ...
    public void load(String string) {
        try {
            ...
            gamePanel.worldTimeCounterForStartJobAfterChangeJob = ds.worldTimeCounterForStartJobAfterChangeJob;
